...
<template>
    <div class="flex flex-col h-screen border-0 border-red-500">
        <div class="pl-96 bg-[#343a3f] bg-no-repeat bg-left" style="background-image: url('escudo-guerrero.png'); background-size:auto 100%">
        ...
        <div style="background-image: url('bg-center-2025-sep.png'); border-radius: 50px" class="
